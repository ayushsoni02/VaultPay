...
export const SendMoney = () => {
    ...
    const handleTransfer = async () => {
        setIsTransferring(true); // Change button appearance
        try {
                ...
                <div className="border h-min text-card-foreground max-w-md p-4 space-y-8 w-96 bg-white shadow-lg rounded-lg relative">
                    ...
                    <div className="p-6">
                        ...
                        <div className="space-y-4">
                            ...
                            {/* Transfer Button with Click Effect */}
                            <button
                                ...
                                className={`justify-center rounded-md text-sm font-medium ring-offset-background transition-colors h-10 px-4 py-2 w-full 
                                    ${isTransferring ? "bg-green-400 cursor-not-allowed" : "bg-green-500 hover:bg-green-600"} 
                                    text-white`}
